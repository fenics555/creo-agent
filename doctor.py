...
p = Path(r"D:\AI\tools\agent\find_tools.py")
p.write_text(FIND, encoding="utf-8")
print("[+] find_tools.py: адаптивная автогруппировка относительно корней + fuzzy-синонимы")
