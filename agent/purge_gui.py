...
SETTINGS_FILE = Path(r"D:\AI\data\purge_gui_settings.json")
LOG_FILE = Path(r"D:\AI\log\purge\purge.log")
LAST_PURGE_FILE = Path(r"D:\AI\log\purge\last_purge.json")
LOCK_FILE = Path(r"D:\AI\log\purge\purge.lock")
