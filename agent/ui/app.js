...
else if(a=="appr"){var sp2=document.getElementById("spin");if(sp2)sp2.style.display="inline-block";J("/approve",{token:TK,pid:el.getAttribute("data-pid"),ok:el.getAttribute("data-ok")=="1"}).then(function(r){if(sp2)sp2.style.display="none";var msgEl=el.closest(".msg");if(msgEl){var btns=msgEl.querySelector("button[data-act='appr']");if(btns)btns.parentElement.remove();}addMsg(esc((r.res||"")+(r.answer&&r.answer!==r.res?"\n\n"+r.answer:"")))});} // 10 = newline
