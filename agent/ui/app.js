...
if(a=='think'){var n=el.nextElementSibling;n.style.display=n.style.display=='none'?'block':'none'}
    ...
    var o=document.getElementById('wp_pdf_out');
    o.innerHTML='<small style=\"color:#A6A8AB\">запуск...</small>';
    J('/wiz_pdf_execute',{token:TK,root:r,keep:k})
    o.innerHTML='<small style="color:#A6A8AB">запуск...</small>';
