# -*- coding: utf-8 -*-
r"""Собирает ОДИН блок spec_tools.py из excel_import.py + excel_export.py (веб-приложение спецификации) + связка с агентом.
Запуск: python make_spec_one.py. Обновились файлы веб-приложения — просто перезапустить."""
import io, os, re

BASE = r"D:\AI\tools\agent"
HEAD = '''# -*- coding: utf-8 -*-
r"""SPEC (единый блок): создание/чтение XLSX (веб-приложение спецификации) + связка с агентом:
